...
public class VisaCardScheme extends CardSchemeBase {

	VisaUnsignedData unsignedData = new VisaUnsignedData();
    VisaCertificateData certificateData = new VisaCertificateData();
    VisaDetachedSignature detachedSignature = new VisaDetachedSignature();
    ...
    public boolean recoverIpkCert(String caPkModulusN, String caPkExponentE, byte[] ipkCertData) {
        try {
            ...
            if (remainLength % caPkModulusNLength == 0) {
                ...
                //String detachedSignatureDecrypted = decryptedNumber.toString(16).toUpperCase();
                ...
                throw new IllegalArgumentException("The certificate data length does not match with the public key length!");
            }
            return true;
